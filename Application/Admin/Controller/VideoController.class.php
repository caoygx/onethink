...
class VideoController extends AdminController {
    ...
    protected function getMenu(){
        ...
        foreach ($cate as $key=>&$value){
            ...
            if($isIndependent){
                $value['url'] = 'video/index?model='.$rModel['name'].'&category_id='.$value['id'];
            }else{
     ...
     */
    public function index($category_id = null, $p = 0){
        //获取左边菜单
        $this->getMenu();
        $model = 'video';
     ...
     * @author huajie <banhuajie@163.com>
     */
    public function add($model = 'video'){
        //获取左边菜单
        $this->getMenu();
     ...
     * @author huajie <banhuajie@163.com>
     */
    public function edit($model = 'video', $id = 0){
        //获取左边菜单
        $this->getMenu();
